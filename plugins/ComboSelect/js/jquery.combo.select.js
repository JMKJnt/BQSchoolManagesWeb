...
(function(factory) {
	...
	$.extend(Plugin.prototype, {
		...
		_construct: function() {
			...
			this.$input = $('<input type="text" name="n" ' + (isMobile ? 'tabindex="-1"' : '') + ' placeholder="' + p + '" class="' + this.settings.inputClass + '">').appendTo(this.$container)
		...
		_blur: function() {
			...
			this._selectByIndex(index);
			if(index == undefined || index == null || index == '' || index == 'null' || index == 'undefined') {
				this._updateInput();
			}
